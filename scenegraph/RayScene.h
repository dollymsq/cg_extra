...
protected:
    ...
    CS123SceneColor illuminatePoint(Vector4 eye, Vector4 dir, REAL t, Vector3 n, CS123SceneMaterial matrl, Vector2 textureCo, int recursiondepth);
    bool isInShadow(Vector3 object, Vector3 raydir, REAL tmin);
